...
There you have it, my first ever anomaly detection model **RAMP**.  If you find it interesting please do read the [paper]({{site.url}}/papers/2019RAMP_extended_paper.pdf), [slides](https://www.researchgate.net/publication/337927011_Slides_-_RAMP_Real-Time_Anomaly_Detection_in_Scientific_Workflows) and play with the [code](https://github.com/dherath/RAMP).

##### So until next time,
##### Cheers!

**Prev: [Implementing Deep Recurrent Neural Networks (RNN)]({{site.url}}/2019/rnn/)**
