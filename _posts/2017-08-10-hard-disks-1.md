...
![intro-image](http://teachbesideme.com/wp-content/uploads/2015/02/solid-liquid-gas-1024x346.jpg){: height="250px"}
...
Now if you look at the velocity distribution below you'll see it's in fact a Boltzmann distribution which is pretty close to how velocities get distributed for particles(like gasses) in a box. So there is in fact some pattern to the particle behavior within the classical limits we defined.
